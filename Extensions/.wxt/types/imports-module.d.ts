...
declare module '#imports' {
  ...
  export { AdCopyPanel } from '../components/AdCopyPanel';
  export { AuthGate, parseAuthHash, applyAuthFromHash, getUserTierLabel } from '../components/AuthGate';
  export { DataLensPanel } from '../components/DataLensPanel';

      ...
      browser.runtime.onMessage.addListener(
        (message, _sender, sendResponse) => {
          if (message.type === "CAPTURE_SCREENSHOT") {
            browser.runtime.sendMessage({ type: "TAKE_SCREENSHOT" }).then(sendResponse).catch((err) => sendResponse({ error: String(err) }));
            return true;
          }
          return false;
        }

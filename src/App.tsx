        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className={`transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <a href="contact.html" className="gapah-button gapah-button-primary text-base">
                Get early access
                <ArrowRight className="w-5 h-5 ml-2" />
              </a>
              <a href="features.html" className="gapah-button gapah-button-secondary text-base group">
      ...
      <div className="w-full px-[7vw] relative z-10">
        <div className={`max-w-3xl mx-auto text-center scroll-reveal ${isVisible ? 'revealed' : ''}`}>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="contact.html" className="gapah-button gapah-button-secondary text-base py-4 px-8 text-white border-white/30 hover:bg-white/10">
              Ask a question
            </a>
          </div>
